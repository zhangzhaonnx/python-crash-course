...
def check_keydown_events(event, ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    """响应按键"""
...
def start_game(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button):
    # 重置游戏设置
...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    check_alien_bullet_cllisions(ai_settings, screen, stats, sb, ship, aliens, bullets)


def check_alien_bullet_cllisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    """检查子弹和外星人的碰撞"""
